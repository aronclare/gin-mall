...
CREATE TABLE `cart` (
  ...
  `max_num` bigint(20) unsigned DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '2023-04-02 14:40:00.333', '2023-04-02 14:58:39.481', null, 'admin', '2633262862@qq.com', '$2a$12$z2/SVzFCiK9W22uYjwJ.WO5ZNOlj23DmMjya74ZiZ0.2WeXnhe.qC', '超级管理员', 'active', 'rsfa3hh3e.hn-bkt.clouddn.comFhQBR-cRCelSfZgM-3r5P_M37y-C', '0');
INSERT INTO `user` VALUES ('2', '2023-04-02 15:46:43.489', '2023-04-02 15:46:43.489', null, 'codeanl1', '', '$2a$12$RX8L7.2cG6AB9YrHN6q8H.PL.tMfbwnhJ6gXdgy1kMQBfMg2aylla', 'codeanl', 'active', 'https://an23.co/upload/2022/07/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20220722020131.jpg', '0');
